...
import "./index.css";
import { HorizontalScroll, Text } from "@vkontakte/vkui";
...
class ReactImageUploadComponent extends React.Component {
  ...
  renderIcon() {
    if (this.props.withIcon) {
      return (
        <div onClick={this.triggerFileUpload} className="upload-button">
          <div>
            <Icon28UploadOutline />
        ...
        <div className="fileContainer" style={this.props.fileContainerStyle}>
          <HorizontalScroll>
            <div className="scroll-inner">
              {this.renderIcon()}
              {this.props.withPreview && this.renderPreviewPictures()}
            </div>
          </HorizontalScroll>
...
ReactImageUploadComponent.defaultProps = {
  ...
  buttonType: "button",
  withLabel: true,
  label: "Mаксимальный размер файла: 5 Мб",
  labelStyles: {},
  labelClass: "",
  imgExtension: [".jpg", ".jpeg", ".png"],
  maxFileSize: 5242880,
  fileSizeError: " слишком большой файл",
  fileTypeError: " неподдерживаемый формат",
  errorClass: "",
  style: {},
  errorStyle: {},
  singleImage: false,
